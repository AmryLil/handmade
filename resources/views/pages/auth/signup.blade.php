...
<head>
    ...
    <title>Sign Up - Nusantara Craft</title>
    ...
    <div class="relative flex items-center w-full justify-center min-h-screen py-12 px-4">
        ...
        <div class="relative w-full max-w-md">
            ...
            <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-slate-100">
                ...
                <div class="p-8">
                    <!-- Title -->
                    <h2 class="text-center text-2xl font-bold text-slate-800 mb-2">Create Account</h2>
                    <p class="font-light text-center mb-6 text-maroon-600">Join our community of craft lovers</p>
                    ...
                    <form action="{{ route('register.submit') }}" method="POST" class="space-y-4">
                        ...
                        <div class="flex items-center mt-4">
                            ...
                            <label for="terms" class="ml-2 block text-sm text-slate-600">
                                I agree to the <a href="#" class="text-maroon-600 hover:underline">Terms of
                                    Service</a> and <a href="#" class="text-maroon-600 hover:underline">Privacy
                                    Policy</a>
                            </label>
                        </div>
                    ...
                    <div class="mt-6 text-center text-sm text-slate-600">
                        ...
                        <a href="#" class="text-maroon-600 font-semibold hover:underline">Sign In</a>
                    </div>
