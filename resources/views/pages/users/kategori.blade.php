                    ...
                    <div
                        ...
                        <div class="relative pb-2/3">
                            @if ($item->path_img_222336)
                                <img src="{{ asset('storage/' . $item->path_img_222336) }}" alt="{{ $item->nama_222336 }}"
                        ...
                        <div class="p-5">
                            <div class="relative">
                                <h3 class="text-lg font-semibold text-gray-900 mb-1">{{ $item->nama_222336 }}</h3>

                                <p class="text-gray-500 text-sm line-clamp-2 mb-4">
                                    {{ $item->deskripsi_222336 ?: 'Tidak ada deskripsi' }}
                                </p>
