    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-600">Perbarui informasi produk.</p>
            </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1 flex items-center">
                                @if ($produk->path_img_222336)
                                    <div class="current-image-container mr-4">
                                ...
                                <div class="upload-button-container">
                                    <label for="image-upload"
                                        ...
                                        <span>{{ $produk->path_img_222336 ? 'Ganti gambar' : 'Upload gambar' }}</span>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="deskripsi_222336" name="deskripsi_222336" rows="4"
                                    class="shadow-sm focus:ring-red-500 focus:border-red-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('deskripsi_222336', $produk->deskripsi_222336) }}</textarea>
                            </div>
