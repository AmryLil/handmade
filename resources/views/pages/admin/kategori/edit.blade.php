    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-semibold text-gray-900">Edit Kategori Produk</h1>
                ...
                <form action="{{ route('admin.kategori_produk.update', $kategori->id_222336) }}" method="POST"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="deskripsi_222336" id="deskripsi_222336" rows="4"
                            class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                            required>{{ old('deskripsi_222336', $kategori->deskripsi_222336) }}</textarea>
                    </div>
                            ...
                            @if ($kategori->path_img_222336)
                                <div class="mb-3">
                                    <img src="{{ Storage::url($kategori->path_img_222336) }}"
                                        alt="{{ $kategori->nama_222336 }}" class="h-32 w-32 object-cover rounded-md">
